...
<div class="container">
    <div class="table-responsive">
        <h3>Data Mahasiswa Baru di Universitas Merdeka Malang</h3>
        <hr>
        <div style="padding-bottom:20px">
        <a href="../adm_mahasiswa/tambah_mhs.php" class="btn btn-primary" title="Tambah data dosen pengajar"><span class="glyphicon glyphicon-pencil"></span> Tambah Data</a>
        </div>
